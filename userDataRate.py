...
def findRequiredUsers(userBehaviour, captureDuration, FWDdatarate, BWDdatarate, numberOfusers, minRate, maxRate, accuracy_level = 0.1):
...
if __name__ == "__main__":
    ...
    # print("done")
    findUserBasedOnThroughput("/home/anath/concatenatedUserBehaviour.csv", 1000, 15*60, 1000)
